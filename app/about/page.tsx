    ...
    <>
      ...
      <main className="pt-[88px]">
        <section style={{ height: "520px", overflow: "hidden", position: "relative" }}>
          <Image src="/images/mihaela-about.jpg" alt="Mihaela Perelighin" fill priority className="object-cover" style={{ objectPosition: "50% 30%" }} />
        </section>
        ...
        <section className="bg-white py-14">
          <div className="max-w-2xl mx-auto px-6 space-y-5 text-charcoal leading-relaxed text-[17px]">
            ...
            <div className="pt-4">
              <a href="/#contact" className="flex items-center justify-center bg-gold-500 hover:bg-gold-600 text-white font-semibold px-8 py-4 rounded-md text-base w-full">
